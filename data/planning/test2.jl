...
cand = Dict(
    :ID         => [1, 2, 3],
    :Node       => [2, 3, 4],
    :Prod_cost  => [[25.0, 25.0, 25.0], [30.0, 30.0, 30.0], [20.0, 20.0, 20.0]],
    :Inv_cost   => [[700000, 700000, 700000], [800000, 800000, 800000], [600000, 600000, 600000]],
    :Prod_cap   => [
...
exist = Dict(
    ...
    :Node      => [1, 4],
    :Max_cap   => [400, 500],
    :Prod_cost => [[35.0, 35.0, 35.0], [32.0, 32.0, 32.0]]
)
...
demands = Dict(
    ...
    :Node => [2, 4],
    :Load => [
        [[246.5, 467.5], [261.0, 495.0], [290.0, 550.0]], 
        [[150.0, 300.0], [170.0, 340.0], [200.0, 400.0]] 
    ]
)

# Economic Parameters
a = [0.2, 0.1, 0.1]                     # Amortization rate [%]
ρ = [
     [6000 2760], # T = 1, o = 1,2
     [6000 2760], # T = 2, o = 1,2
     [6000 2760]  # T = 3, o = 1,2
